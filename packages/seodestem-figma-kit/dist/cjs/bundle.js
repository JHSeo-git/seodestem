...
async function fetchWrapper(fetchOptions) {
    try {
        ...
        const response = await fetch(fetchOptions.url, requestOptions);
...
function routeParse(route) {
    if (typeof route !== 'string')
        throw new Error('Route is not string type');
