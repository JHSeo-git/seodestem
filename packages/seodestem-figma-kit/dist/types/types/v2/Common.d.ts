...
/** */
export declare type ExtractRequestParameters<T> = 'parameters' extends keyof T ? UnionToIntersection<{
    [K in keyof T['parameters']]: T['parameters'][K];
}[keyof T['parameters']]> : {};
export declare type ExtractRequestRequestBody<T> = 'requestBody' extends keyof T ? UnionToIntersection<{
